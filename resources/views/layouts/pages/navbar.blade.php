<nav class="flex items-center justify-between flex-wrap bg-white border-b-2 border-gray-900">
    <div class="w-full container mx-auto flex flex-wrap items-center justify-between">
        <div class="flex items-center no-underline pr-6">
            <div>
                <a href="/"><img src="../img/logo.png"></a>
            </div>
            <div class="ml-2 items-bottom">
                <a href="/"><img src="../img/motto.png"></a>
            </div>
        </div>
        <div class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div class="w-full container mx-auto flex flex-col sm:flex-row items-center justify-center text-sm font-bold uppercase mt-0 px- py-2">
                ...
                <a href="about" class="hover:text-gray-400 rounded py-4 px-2 mx-2">About </a>
                <a href="surveys" target="_blank" class="hover:text-gray-400 rounded py-4 px-2 mx-2">Surveys</a>

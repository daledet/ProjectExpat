        ...
        <div class="container mx-auto">
            <div class="inputs w-full max-w-2xl p-6 mx-auto">
                <form class="mt-6 pt-4">
                    <h2 class="text-2xl text-gray-900">Family Information:</h2>
                    <div class="flex items-center justify-between mt-4">

                        <div class='w-full md:w-full mb-6'>
                            <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>Are you
                                Married or in a domestic partnership?</label>
                    ...
                    <div class='w-full md:w-full mb-6'>
                        <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>What
                            is
                            his / her nationality?</label>
                    ...
                    <div class='w-full md:w-full mb-6'>
                        <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>What
                            languages does he / she speak? </label>
                        <div class="flex-shrink w-full inline-block relative">
                            <select
                                class="block appearance-none text-gray-600 w-full bg-white border border-gray-400 shadow-inner px-4 py-2 pr-8 rounded"
